...
import type { BpmAnswer, BpmItemSnapshot, CalculatedResult, RiskLevel, RiskRuleVersion } from '@ebr-bpm/risk-engine';
...
function calcularEscenario(escenario: EscenarioRiesgo): CalculatedResult {
  const resultado = calculateInspectionRisk({
    ...
    bpm: {
      ...
      items: escenario.itemsBpm ?? [{ itemId: 'item-1.1.1', code: '1.1.1', answer: escenario.respuestaBpm }],
    },
    products: {
...
const itemsBpmMedio: BpmItemSnapshot[] = [
  { itemId: 'item-1.1.1', code: '1.1.1', answer: 'C' },
  { itemId: 'item-1.1.2', code: '1.1.2', answer: 'C' },
  { itemId: 'item-1.2.1', code: '1.2.1', answer: 'C' },
  { itemId: 'item-2.1.1', code: '2.1.1', answer: 'CP' },
  { itemId: 'item-2.2.1', code: '2.2.1', answer: 'C' },
  { itemId: 'item-3.1.1', code: '3.1.1', answer: 'IT' },
  { itemId: 'item-4.1.1', code: '4.1.1', answer: 'C' },
  { itemId: 'item-5.1.1', code: '5.1.1', answer: 'C' },
  { itemId: 'item-5.3', code: '5.3', answer: 'NA', allowsPartial: false },
];

const resultadoMedio = calcularEscenario({
  id: 'eva-2026-0017', respuestaBpm: 'C', itemsBpm: itemsBpmMedio, riesgoProducto: 'ALTO', volumen: '150000',
