              ...
              <TableBody>
                {evaluaciones.map((evaluacion) => (
                  <TableRow key={evaluacion.id} hover>
                    ...
                    <TableCell><Typography variant="body2">{evaluacion.empresa.nombreComercial}</Typography><Typography variant="caption" color="text.secondary">{evaluacion.establecimiento}</Typography></TableCell>
