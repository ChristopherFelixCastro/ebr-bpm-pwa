...
export function HomePage() {
  ...
  return <Box>
    ...
    <Card><CardContent>
      ...
      <Typography sx={{ mb: 2 }}>El directorio empresarial, las solicitudes BPM, la operación sanitaria y las inspecciones de campo están disponibles según su rol.</Typography>
