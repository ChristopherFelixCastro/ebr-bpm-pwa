...
export type CompanyRequestDetail = CompanyRequest & { caseId: string | null; contacts: RequestContact[]; documentSummary: { total: number; pending: number; valid: number; rejected: number; archived: number } }
