...
export const capabilities: readonly Capability[] = [
  ...
  { id: 'corrections', label: 'Correcciones', path: '/campo/correcciones', section: 'Inspecciones de campo', roles: ['EVALUATOR'], ready: true },
  { id: 'analytics', label: 'Evaluaciones', path: '/evaluaciones', section: 'Evaluación y cierre', roles: coordination, ready: true },
