...
| `user_authorization_documents` | `id`, `user_id`, `storage_path`, `file_name`, `mime_type`, `size_bytes`, `status`, `uploaded_at`, `deleted_at` | Carta de autorización: PDF o imagen, máximo 5 MB; requerida antes de aprobar al usuario. |
